const Footer = () => {
  return <footer className="bg-white lg:grid lg:grid-cols-5 dark:bg-gray-900 pt-40 font-serif " >
    ...
    <div className="mt-12 border-t border-gray-100 pt-12 dark:border-gray-800">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <p className="mt-8 text-xs text-gray-500 sm:mt-0 dark:text-gray-400">
          &copy; 2024. Damián Catalano. Todos los derechos reservados
        </p>
      </div>
    </div>
  </div>
